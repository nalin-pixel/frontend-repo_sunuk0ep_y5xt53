    ...
    <section id="contact" className="relative py-28">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <p className="text-sm uppercase tracking-widest text-cyan-300/80">Contact</p>
            <h2 className="mt-2 text-3xl md:text-4xl font-bold text-white tracking-tight">Let’s Build on Sui</h2>
            <p className="mt-4 text-slate-300">Tell us about your idea, timelines and what success looks like. We’ll get back within 24 hours.</p>
            <div className="mt-6 flex items-center gap-3 text-slate-300"><Mail size={18} /> hello@sui.gh</div>
          </div>

          <motion.form onSubmit={onSubmit} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="relative overflow-hidden rounded-2xl border border-white/10 bg-slate-900/60 p-6 backdrop-blur space-y-4 neon-border">
            <div className="absolute -bottom-16 -left-10 w-64 h-64 rounded-full bg-indigo-500/20 blur-3xl" />
            ...
            <button type="submit" className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-cyan-400 via-sky-400 to-indigo-400 px-5 py-3 font-semibold text-slate-900 shadow-[0_10px_30px_rgba(56,189,248,0.35)] hover:shadow-[0_14px_40px_rgba(56,189,248,0.45)] transition-shadow">
              <Send size={18} />
